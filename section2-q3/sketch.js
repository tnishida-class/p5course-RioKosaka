...
function setup() {
  ...
  drawArcs1(green, red, maxR * 0.8);
//
  // BLANK[1] (hint: drawArcs x 3, drawCircle x 1)
  drawArcs2(cream, black, maxR * 0.75);
  drawArcs3(green, red, maxR * 0.5);
  drawArcs4(cream, black, maxR * 0.45);
